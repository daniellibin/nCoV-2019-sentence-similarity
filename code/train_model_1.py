...
def read_data():
    ...
    df1 = pd.read_csv("../data/External/train_dev.csv")
    df2 = pd.read_csv("../data/External/train_dev_improve.csv")
...
if __name__ == '__main__':
    ...
    for fold, (train_index, valid_index) in enumerate(skf.split(train_x, train_y)):
        ...
        model_weight_filepath = "../user_data/model_data/" + str(1) + "_" + str(fold) + ".weights"
